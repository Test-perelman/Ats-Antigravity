...
export default function JobDetailView({ jobId }: JobDetailViewProps) {
    ...
    return (
        <div className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-card border rounded shadow p-6">
                        ...
                        <p className="whitespace-pre-wrap text-muted-foreground text-sm leading-relaxed">{job.description || 'No description provided.'}</p>
                    </div>

                    <div className="bg-card border rounded shadow p-6">
                        <h2 className="font-semibold text-lg mb-4">Visa Requirements</h2>
                        <p className="text-muted-foreground text-sm">{job.visaRequirements || 'None specified.'}</p>
                    </div>
                </div>
            ...
            {/* Submit Candidate Modal - Using fixed positioning to overlay on top of everything including parent modal */}
            {isSubmitModalOpen && (
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60]">
                    <div className="bg-background p-6 rounded-lg shadow-xl w-full max-w-md border">
                        ...
                        <form onSubmit={handleSubmitCandidate} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1">Submitted Rate</label>
                                <input
                                    className="w-full p-2 border rounded bg-background"
                                    value={submittedRate}
