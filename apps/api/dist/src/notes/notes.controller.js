...
let NotesController = class NotesController {
    ...
    findAll(entityType, entityId) {
        return this.notesService.findAll(entityType, entityId);
    }
    findOne(id) {
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('admin', 'team_admin', 'manager', 'recruiter'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, roles_decorator_1.Roles)('team_admin', 'manager', 'recruiter'),
    __param(0, (0, common_1.Param)('id')),
